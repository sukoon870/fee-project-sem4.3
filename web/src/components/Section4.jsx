const Section4 = () => {
    return (
        <section className="w-full relative bg-theme1">
            <span className="w-full h-20 -scale-100 absolute top-0 left-0 bg-white section-border-clip"></span>

            <div className="flex items-start md:p-40">
                <div className="w-1/2 text-white flex flex-col items-start gap-10">
                    ...
                    <button className="relative font-bold text-xl px-8 py-4 ml-8 group border-black border-2 skew-x-[-35deg]">
